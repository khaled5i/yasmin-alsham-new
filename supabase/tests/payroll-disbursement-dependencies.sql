-- Disposable fixture dependencies. Never apply to the application database.
CREATE OR REPLACE FUNCTION public.ensure_worker_payroll_month(p_branch character varying, p_worker_id text, p_worker_name text, p_year integer, p_month integer)
