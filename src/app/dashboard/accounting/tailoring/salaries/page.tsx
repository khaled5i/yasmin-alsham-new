...
const SALARY_CATEGORIES = [
  ...
  { id: 'overtime', label: 'ساعات إضافية' },
...
function SalariesContent() {
  ...
  const loadExpenses = async () => {
    try {
      const data = await getExpenses('tailoring', 'salary')
      setExpenses(data)
    } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const expenseData: CreateExpenseInput = {
        ...
        description: formData.employee_name ? `${formData.employee_name} - ${getCategoryLabel(formData.category || '')}` : formData.description || '',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100" dir="rtl">
      <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-gray-900">رواتب العمال</h1>
                  <p className="text-gray-500">رواتب ومكافآت العاملين</p>
                </div>
              </div>
            </div>
            <button
            ...
            >
              ...
              <span className="hidden md:inline">إضافة راتب</span>
            </button>
          </div>
        </motion.div>
        ...
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-6 text-white mb-6"
        >
          <div className="flex items-center justify-between">
            <div>
              <p className="text-purple-100 mb-1">إجمالي الرواتب</p>
              <p className="text-3xl font-bold">{formatCurrency(totalExpenses)}</p>
            </div>
            <div className="text-left">
              <p className="text-purple-100 mb-1">عدد العمليات</p>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pr-10 pl-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              />
            </div>
          </div>
        </motion.div>
        ...
        >
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">لا توجد رواتب مسجلة</p>
              <button
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-900">{item.description || 'موظف'}</h4>
