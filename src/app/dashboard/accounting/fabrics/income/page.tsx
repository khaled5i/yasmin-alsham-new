...
import { getIncome, createIncome } from '@/lib/services/simple-accounting-service'
            ...
            >
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-xl font-bold text-gray-900">إضافة مبيعة جديدة</h2>
