...
const arTranslations: Translations = {
  ...
  'status': 'الحالة',
  'price': 'السعر',
  'paid_amount': 'الدفعة المستلمة',
  'remaining_amount': 'الدفعة المتبقية',
  'payment_warning': 'تنبيه دفعة متبقية',
  'remaining_payment_warning_message': 'يوجد دفعة متبقية غير مدفوعة',
  'payment_warning_question': 'هل تريد تحديث حالة الدفع قبل تسليم الطلب؟',
  'mark_as_paid': 'تم الدفع - تحديث المبلغ',
  'ignore_and_deliver': 'تجاهل وتسليم الطلب',
  'payment_warning_note': 'عند اختيار "تم الدفع"، سيتم تحديث المبلغ المدفوع ليساوي السعر الكلي وتغيير حالة الدفع إلى "مدفوع"',
  'note': 'ملاحظة',
  'total': 'المجموع',
  'description': 'الوصف',
  'notes': 'ملاحظات',
  ...
  'warning': 'تحذير',
  'info': 'معلومات',
  'order_added_success': 'تم حفظ الطلب بنجاح',
  'redirecting_to_orders': 'جاري التوجيه إلى صفحة الطلبات...',
  ...
  'order_delete_error': 'حدث خطأ أثناء حذف الطلب',
  'order_add_error': 'حدث خطأ أثناء إضافة الطلب',
  'work_started_success': 'تم بدء العمل على الطلب',
  'work_start_error': 'حدث خطأ أثناء بدء العمل',
  'order_completed_success': 'تم إنهاء العمل على الطلب بنجاح',
  'order_complete_error': 'حدث خطأ أثناء إنهاء العمل',
  ...
  'measurements_cm': 'المقاسات (بالإنش)',
  ...
  'search_completed_orders': 'البحث في الطلبات المكتملة...',
...
const enTranslations: Translations = {
  ...
  'remaining_payment_warning_message': 'There is an unpaid remaining amount',
  'payment_warning_question': 'Do you want to update the payment status before delivering the order?',
  'mark_as_paid': 'Mark as Paid - Update Amount',
  'ignore_and_deliver': 'Ignore and Deliver Order',
  'payment_warning_note': 'When selecting "Mark as Paid", the paid amount will be updated to equal the total price and the payment status will be changed to "Paid"',
  'note': 'Note',
  'total': 'Total',
  ...
  'warning': 'Warning',
  'info': 'Info',
  'order_added_success': 'Order saved successfully',
  'redirecting_to_orders': 'Redirecting to orders page...',
  ...
  'order_add_error': 'Error adding order',
  'work_started_success': 'Work started on order',
  'work_start_error': 'Error starting work',
  'order_completed_success': 'Order completed successfully',
  'order_complete_error': 'Error completing order',
  ...
  'price_sar': 'Price (SAR)',
  'measurements_cm': 'Measurements (inch)',
