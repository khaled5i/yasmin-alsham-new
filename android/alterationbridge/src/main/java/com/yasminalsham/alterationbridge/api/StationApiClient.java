...
import com.yasminalsham.alterationbridge.BuildConfig;
...
public final class StationApiClient {
    ...
    private static final String RPC_HEARTBEAT = "alterations_station_heartbeat";
    private static final String RPC_CLAIM_JOB = "alterations_station_claim_job";
    private static final String RPC_BEGIN_SEND = "alterations_station_begin_send";
    private static final String RPC_COMPLETE_JOB = "alterations_station_complete_job";
    private static final String RPC_FAIL_JOB = "alterations_station_fail_job";
    private static final String RPC_RELEASE = "alterations_station_release";
