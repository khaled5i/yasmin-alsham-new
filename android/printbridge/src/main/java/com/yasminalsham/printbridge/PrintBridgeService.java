...
public final class PrintBridgeService extends Service implements StationCoordinator.Listener {
    ...
    public static final String ACTION_UNPAIR = "com.yasminalsham.printbridge.UNPAIR";
    public static final String ACTION_CONFIG_CHANGED =
            "com.yasminalsham.printbridge.CONFIG_CHANGED";
    public static final String ACTION_STATUS = "com.yasminalsham.printbridge.STATUS";

    public static final String EXTRA_ROLE = "role";
    public static final String EXTRA_MESSAGE = "message";

    private static final int NOTIFICATION_ID = 19281;
    private static final String CHANNEL_ID = "yasmin_print_station";
    ...
    public void onCreate() {
        ...
        startForeground(NOTIFICATION_ID, buildNotification("جارٍ تشغيل محطة الطباعة"));
        acquireWakeLock();
    ...
    private void createNotificationChannel() {
        ...
        channel.setDescription("محطة الطباعة التلقائية لقسم التفصيل");
    ...
    private Notification buildNotification(String text) {
        ...
        return builder
                ...
                .setContentTitle("محطة طباعة ياسمين الشام")
                .setContentText(text)
    ...
    private void acquireWakeLock() {
        ...
        wakeLock = powerManager.newWakeLock(
                ...
                getPackageName() + ":tailoring_print_station"
        );
        ...
        switch (status.role) {
            case ACTIVE:
                return status.printerReachable
                        ? "المحطة الرئيسية جاهزة والطابعة متصلة"
                        : "المحطة الرئيسية تعمل، والطابعة غير متاحة";
            case STANDBY:
    ...
    private String buildHealthJson() {
        ...
        try {
            json.put("ok", running);
            json.put("service", "yasmin-print-station");
